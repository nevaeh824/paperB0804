...
> 数据：`data0804/invest_panel_weo.csv` 与 `WSDI/data/processed/wsdi_sovereign61_1995_2018.csv`；整合生成时间：2026-08-30 12:09（Asia/Shanghai）。
...
- Baseline 全交互模型中，A×b-pre 系数为 -0.0899（p=<0.001），A×X 系数为 -0.0007（p=0.984）。
