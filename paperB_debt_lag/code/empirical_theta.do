...
label variable c_b "lagged debt/GDP b_pre centered on spread sample"
...
label variable spread_saving_component "Lagged debt/GDP ratio times marginal spread-ratio relief"
